...
public class Genetic3 {
    ...
    private Individual3[] m_population;
 ...
 static int w[]=new int[MAX_ITER*POP_SIZE];
    ...
    public Genetic3() {
        m_population = new Individual3[POP_SIZE];

        // init population
        for (int i = 0; i < POP_SIZE; i++) {
            m_population[i] = new Individual3();
    ...
    public Individual3 rouletteWheelSelection() {
        for(int i=0;i<POP_SIZE;i++){
      ...
      public Individual3 findBestIndividual() {
       ...
       // return m_population[idxMax];        // maximization
         ...
         public static Individual3[] crossover(Individual3 indiv1,Individual3 indiv2) {
        Individual3[] newIndiv = new Individual3[2];
        newIndiv[0] = new Individual3();
        newIndiv[1] = new Individual3();

        int randPoint = m_rand.nextInt(Individual3.SIZE);
        int i;
        ...
        public  void fun2() {
        //Genetic3 pop = new Genetic3();
        Individual3[] newPop = new Individual3[POP_SIZE];
        Individual3[] indiv = new Individual3[2];
...
//System.out.println("count"+"b:"+indiv[1].getValue1()+","+indiv[1].getValue2()+","+indiv[1].getValue3());
    ...
    //        System.out.print("Total Fitness = " + pop.totalFitness);
        ...
        // best indiv
        Individual3 bestIndiv = this.findBestIndividual();
