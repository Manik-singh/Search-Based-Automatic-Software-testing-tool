...
public class Genetic4 {
    ...
    private Individual4[] m_population;
 ...
 static int w[]=new int[MAX_ITER*POP_SIZE];
    ...
    public Genetic4() {
        m_population = new Individual4[POP_SIZE];

        // init population
        for (int i = 0; i < POP_SIZE; i++) {
            m_population[i] = new Individual4();
    ...
    public Individual4 rouletteWheelSelection() {
        for(int i=0;i<POP_SIZE;i++){
      ...
      public Individual4 findBestIndividual() {
       ...
       // return m_population[idxMax];        // maximization
         ...
         public static Individual4[] crossover(Individual4 indiv1,Individual4 indiv2) {
        Individual4[] newIndiv = new Individual4[2];
        newIndiv[0] = new Individual4();
        newIndiv[1] = new Individual4();

        int randPoint = m_rand.nextInt(Individual4.SIZE);
        int i;
       ...
       // Genetic2 pop = new Genetic2();
        Individual4[] newPop = new Individual4[POP_SIZE];
        Individual4[] indiv = new Individual4[2];
...
//System.out.println("count"+"b:"+indiv[1].getValue1()+","+indiv[1].getValue2()+","+indiv[1].getValue3());
 ...
 long time_2 = System.currentTimeMillis();
         ...
         long timediff=time_2-time_1;
        System.out.println("Time took by all Iteration is \t"+timediff+"  milliseconds");

        // best indiv
        Individual4 bestIndiv = this.findBestIndividual();
        System.out.println("Solution Found at Iteration: \t"+(this.w[0]+1));
